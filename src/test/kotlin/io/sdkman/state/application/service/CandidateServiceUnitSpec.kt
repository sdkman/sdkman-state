    ...
    ShouldSpec({
        ...
        context("list") {
            ...
            should("pair every other candidate with its findLtsDefaults entry") {
                ...
                result.shouldBeRight() shouldBe
                    listOf(
                        ListedCandidate(candidate("groovy"), "4.0.28".some()),
                        ListedCandidate(candidate("scala"), none()),
                    )
            }
        ...
        context("register") {
            should("delegate to the repository upsert and report whether the row is new") {
                ...
                coEvery { candidatesRepo.upsert(registration) } returns
                    Either.Right(CandidateRegistrationResult.Registered(candidate("groovy")))
                ...
                result.shouldBeRight() shouldBe CandidateRegistrationResult.Registered(candidate("groovy"))
            }
