...
fun Route.versionWriteRoutes(
    versionService: VersionService,
    strictVersionCandidates: Set<String>,
) {
    versionCreateRoute(versionService, strictVersionCandidates)
...
private fun Route.versionCreateRoute(
    ...
    post("/versions") {
        ...
        VersionRequestValidator.validateRequest(requestBody, strictVersionCandidates).fold(
            ifLeft = { errors ->
