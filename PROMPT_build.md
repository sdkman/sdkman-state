...
2. After implementing functionality or resolving problems, run `./gradlew test` for validation. If functionality is missing then it's your job to add it as per the application specifications. Ultrathink.
